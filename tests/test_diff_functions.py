...
def test_generate_diff_with_recursive_files(file_ext):
    ...
    diff_output2 = read_diff_output('rec_file2_diff_rec_file1')
    assert generate_diff(rec_file2_path, rec_file1_path) == diff_output2

    diff_output3 = read_diff_output('plain_file1_diff_rec_file1')
    assert generate_diff(plain_file1_path, rec_file1_path) == diff_output3
...
def test_generate_diff_with_empty_files(file_ext):
    ...
    diff_output4 = read_diff_output('empty_diff_rec_file1')
    assert generate_diff(empty_file_path, rec_file1_path) == diff_output4

    diff_output5 = read_diff_output('rec_file1_diff_empty')
    assert generate_diff(rec_file1_path, empty_file_path) == diff_output5
